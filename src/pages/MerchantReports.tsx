      ...
      <div className="container mx-auto px-4 lg:px-8 py-6 pt-20 sm:pt-24 pb-24 lg:pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          {!canAccess("advanced_reports") ? (
            ...
            <ScrollReveal>
              <h1 className="text-xl font-bold text-foreground mb-4">Advanced Reports</h1>
              <div className="bg-card rounded-2xl p-8 border border-border/50 shadow-card text-center">
                <FileBarChart size={40} className="mx-auto mb-3 text-secondary/40" />
                <p className="text-sm text-muted-foreground">Advanced reporting coming soon.</p>
                <p className="text-xs text-muted-foreground mt-1">Export detailed reports and access advanced business analytics.</p>
              </div>
            </ScrollReveal>
          )}
        </div>
