...
export const PrototypeShell = ({ device, flow, screens, activeScreen, onDeviceChange, onFlowChange, onScreenChange, children }: PrototypeShellProps) => (
      ...
      <div className="relative mx-auto max-w-7xl space-y-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-3xl font-black tracking-tight text-foreground sm:text-4xl lg:text-5xl">PerkBack SaaS loyalty platform</h1>
            <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground">Mobile-first customer and merchant flows with polished desktop SaaS screens for the next PerkBack redesign pass.</p>
          </div>
        ...
        <PrototypeControls device={device} flow={flow} onDeviceChange={onDeviceChange} onFlowChange={onFlowChange} />
      </div>
    </section>
    <section className="mx-auto grid max-w-7xl gap-6 px-4 py-6 lg:grid-cols-[18rem_1fr] lg:px-8">
      ...
      <div className="space-y-4">
        <div className="flex flex-col gap-2 rounded-2xl border border-border bg-card p-4 shadow-card sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="eyebrow">{device} · {flow}</p>
