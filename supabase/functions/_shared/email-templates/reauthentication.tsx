...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your PerkBack verification code</Preview>
    <Body style={main}>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: '#0a1f5c', margin: '0 0 30px', letterSpacing: '4px' }
